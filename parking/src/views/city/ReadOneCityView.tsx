// importatation de layout et html
...
// création de la fonction ReadOneCityView avec comme paramètres city et parkings
// qui retourne une vue HTML avec une ville et ses parkings grace a Layout
